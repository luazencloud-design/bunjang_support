...
const { useState: useStateSP, useEffect: useEffectSP, useMemo: useMemoSP, useRef: useRefSP } = React;
...
const sidepanelCss = `
  ...
  .sp-num:focus-within{ border-color: var(--accent); box-shadow: 0 0 0 3px oklch(68% 0.15 45 / .12); }
  .sp-num input{
